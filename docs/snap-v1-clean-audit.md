...
|---|--:|--:|--:|--:|
| BJ_C1 | 233 | 68.7% | 71.6% (126/176) | 24.5% |
| BJ_C3 | 458 | 62.9% | 69.8% (229/328) | 29.0% |
| F67 | 491 | 47.5% | 53.3% (171/321) | 20.4% |
| IntlSB20 | 648 | 39.7% | 37.2% (146/392) | 23.0% |
| **加权合计** | 1830 | 51.3% | 55.2% (672/1217) | 24.0% |
...
孤立点 snap_v1 fallback 仍高（≥40%），**确认 precursor 主导**：本数据真实点击的 ~15–25 ms 前导子瞬态令 snap_v1「1 ms 安静 → +6 dB arm」在多数点击上无脚点可就绪。退役 snap_v1、改用峰值相对的 snap_v2 这一决策，在干净数字上依然成立——脏的 60% 仅作历史记录，不再作为依据。
